...
module.exports.pushOrderPurchaseList = function (req, res, next) {
    ...
    req.body.purchaseCart.orders.forEach(product => {              //  by completion of 13 module
        purchases.push({                                         //(ORDER.PRODUCTS) WILL GET CLEAR DURING FRONTEND
                                                                // replacement of (purchaseCart.orders)
            _id: product._id,
            description: product.description,
            quantity: product.quantity, // Investigation required,  by completion of 13 module
